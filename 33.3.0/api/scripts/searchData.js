...
{"l":"scamper/http.html","n":"bytesToEntity","t":"given bytesToEntity: bytesToEntity.type","d":"scamper/http","k":"given"},
{"l":"scamper/http.html","n":"fileToEntity","t":"given fileToEntity: fileToEntity.type","d":"scamper/http","k":"given"},
{"l":"scamper/http.html","n":"getHeader","t":"def getHeader(name: String): Option[Header]","d":"scamper/http","k":"def"},
{"l":"scamper/http.html","n":"getHeaderOrElse","t":"def getHeaderOrElse(name: String, default: => Header): Header","d":"scamper/http","k":"def"},
{"l":"scamper/http.html","n":"getHeaderValue","t":"def getHeaderValue(name: String): Option[String]","d":"scamper/http","k":"def"},
{"l":"scamper/http.html","n":"getHeaderValueOrElse","t":"def getHeaderValueOrElse(name: String, default: => String): String","d":"scamper/http","k":"def"},
{"l":"scamper/http.html","n":"getHeaderValues","t":"def getHeaderValues(name: String): Seq[String]","d":"scamper/http","k":"def"},
{"l":"scamper/http.html","n":"getHeaders","t":"def getHeaders(name: String): Seq[Header]","d":"scamper/http","k":"def"},
{"l":"scamper/http.html","n":"hasHeader","t":"def hasHeader(name: String): Boolean","d":"scamper/http","k":"def"},
{"l":"scamper/http.html","n":"inputStreamToEntity","t":"given inputStreamToEntity: inputStreamToEntity.type","d":"scamper/http","k":"given"},
{"l":"scamper/http.html","n":"intToResponseStatus","t":"given intToResponseStatus: intToResponseStatus.type","d":"scamper/http","k":"given"},
...
{"l":"scamper/http.html","n":"stringToEntity","t":"given stringToEntity: stringToEntity.type","d":"scamper/http","k":"given"},
{"l":"scamper/http.html","n":"stringToHeader","t":"given stringToHeader: stringToHeader.type","d":"scamper/http","k":"given"},
{"l":"scamper/http.html","n":"stringToRequestMethod","t":"given stringToRequestMethod: stringToRequestMethod.type","d":"scamper/http","k":"given"},
{"l":"scamper/http.html","n":"stringToUri","t":"given stringToUri: stringToUri.type","d":"scamper/http","k":"given"},
{"l":"scamper/http.html","n":"tupleToHeader","t":"given tupleToHeader: tupleToHeader.type","d":"scamper/http","k":"given"},
{"l":"scamper/http.html","n":"tupleToHeaderWithDateValue","t":"given tupleToHeaderWithDateValue: tupleToHeaderWithDateValue.type","d":"scamper/http","k":"given"},
{"l":"scamper/http.html","n":"tupleToHeaderWithIntValue","t":"given tupleToHeaderWithIntValue: tupleToHeaderWithIntValue.type","d":"scamper/http","k":"given"},
{"l":"scamper/http.html","n":"tupleToHeaderWithLongValue","t":"given tupleToHeaderWithLongValue: tupleToHeaderWithLongValue.type","d":"scamper/http","k":"given"},
{"l":"scamper/http.html","n":"writerToEntity","t":"given writerToEntity: writerToEntity.type","d":"scamper/http","k":"given"},
...
{"l":"scamper/http/BodyParser$.html","n":"unit","t":"def unit(maxLength: Long, bufferSize: Int): BodyParser[Unit]","d":"scamper/http/BodyParser$","k":"def"},
...
{"l":"scamper/http/Header.html","n":"dateValue","t":"def dateValue: Instant","d":"scamper/http/Header","k":"def"},
...
{"l":"scamper/http/HttpMessage.html","n":"drain","t":"def drain(maxLength: Long): HttpMessage","d":"scamper/http/HttpMessage","k":"def"},
{"l":"scamper/http/HttpMessage.html","n":"drain","t":"def drain(sink: Array[Byte]): Int","d":"scamper/http/HttpMessage","k":"def"},
{"l":"scamper/http/HttpMessage.html","n":"drain","t":"def drain(sink: Array[Byte], offset: Int, length: Int): Int","d":"scamper/http/HttpMessage","k":"def"},
{"l":"scamper/http/HttpMessage.html","n":"drain","t":"def drain(sink: ByteBuffer): sink","d":"scamper/http/HttpMessage","k":"def"},
{"l":"scamper/http/HttpMessage.html","n":"drain","t":"def drain(sink: OutputStream, maxLength: Long): sink","d":"scamper/http/HttpMessage","k":"def"},
{"l":"scamper/http/HttpMessage.html","n":"drain","t":"def drain(sink: WritableByteChannel, maxLength: Long): sink","d":"scamper/http/HttpMessage","k":"def"},
...
{"l":"scamper/http/bytesToEntity$.html","n":"bytesToEntity","t":"object bytesToEntity extends Conversion[Array[Byte], Entity]","d":"scamper/http/bytesToEntity$","k":"object"},
{"l":"scamper/http/bytesToEntity$.html","n":"apply","t":"def apply(entity: Array[Byte]): Entity","d":"scamper/http/bytesToEntity$","k":"def"},
{"l":"scamper/http/fileToEntity$.html","n":"fileToEntity","t":"object fileToEntity extends Conversion[File, Entity]","d":"scamper/http/fileToEntity$","k":"object"},
{"l":"scamper/http/fileToEntity$.html","n":"apply","t":"def apply(entity: File): Entity","d":"scamper/http/fileToEntity$","k":"def"},
{"l":"scamper/http/inputStreamToEntity$.html","n":"inputStreamToEntity","t":"object inputStreamToEntity extends Conversion[InputStream, Entity]","d":"scamper/http/inputStreamToEntity$","k":"object"},
...
{"l":"scamper/http/intToResponseStatus$.html","n":"intToResponseStatus","t":"object intToResponseStatus extends Conversion[Int, ResponseStatus]","d":"scamper/http/intToResponseStatus$","k":"object"},
...
{"l":"scamper/http/stringToEntity$.html","n":"stringToEntity","t":"object stringToEntity extends Conversion[String, Entity]","d":"scamper/http/stringToEntity$","k":"object"},
{"l":"scamper/http/stringToEntity$.html","n":"apply","t":"def apply(entity: String): Entity","d":"scamper/http/stringToEntity$","k":"def"},
{"l":"scamper/http/stringToHeader$.html","n":"stringToHeader","t":"object stringToHeader extends Conversion[String, Header]","d":"scamper/http/stringToHeader$","k":"object"},
{"l":"scamper/http/stringToHeader$.html","n":"apply","t":"def apply(header: String): Header","d":"scamper/http/stringToHeader$","k":"def"},
{"l":"scamper/http/stringToRequestMethod$.html","n":"stringToRequestMethod","t":"object stringToRequestMethod extends Conversion[String, RequestMethod]","d":"scamper/http/stringToRequestMethod$","k":"object"},
...
{"l":"scamper/http/stringToUri$.html","n":"stringToUri","t":"object stringToUri extends Conversion[String, Uri]","d":"scamper/http/stringToUri$","k":"object"},
{"l":"scamper/http/stringToUri$.html","n":"apply","t":"def apply(uri: String): Uri","d":"scamper/http/stringToUri$","k":"def"},
{"l":"scamper/http/tupleToHeader$.html","n":"tupleToHeader","t":"object tupleToHeader extends Conversion[(String, String), Header]","d":"scamper/http/tupleToHeader$","k":"object"},
{"l":"scamper/http/tupleToHeader$.html","n":"apply","t":"def apply(header: (String, String)): Header","d":"scamper/http/tupleToHeader$","k":"def"},
{"l":"scamper/http/tupleToHeaderWithDateValue$.html","n":"tupleToHeaderWithDateValue","t":"object tupleToHeaderWithDateValue extends Conversion[(String, Instant), Header]","d":"scamper/http/tupleToHeaderWithDateValue$","k":"object"},
...
{"l":"scamper/http/tupleToHeaderWithIntValue$.html","n":"tupleToHeaderWithIntValue","t":"object tupleToHeaderWithIntValue extends Conversion[(String, Int), Header]","d":"scamper/http/tupleToHeaderWithIntValue$","k":"object"},
...
{"l":"scamper/http/tupleToHeaderWithLongValue$.html","n":"tupleToHeaderWithLongValue","t":"object tupleToHeaderWithLongValue extends Conversion[(String, Long), Header]","d":"scamper/http/tupleToHeaderWithLongValue$","k":"object"},
...
{"l":"scamper/http/writerToEntity$.html","n":"writerToEntity","t":"object writerToEntity extends Conversion[OutputStream => Unit, Entity]","d":"scamper/http/writerToEntity$","k":"object"},
...
{"l":"scamper/http/auth.html","n":"stringToChallenge","t":"given stringToChallenge: stringToChallenge.type","d":"scamper/http/auth","k":"given"},
{"l":"scamper/http/auth.html","n":"stringToCredentials","t":"given stringToCredentials: stringToCredentials.type","d":"scamper/http/auth","k":"given"},
...
{"l":"scamper/http/auth/stringToChallenge$.html","n":"stringToChallenge","t":"object stringToChallenge extends Conversion[String, Challenge]","d":"scamper/http/auth/stringToChallenge$","k":"object"},
...
{"l":"scamper/http/auth/stringToCredentials$.html","n":"stringToCredentials","t":"object stringToCredentials extends Conversion[String, Credentials]","d":"scamper/http/auth/stringToCredentials$","k":"object"},
...
{"l":"scamper/http/client/ClientHttpResponse.html","n":"claim","t":"def claim(): HttpResponse","d":"scamper/http/client/ClientHttpResponse","k":"def"},
...
{"l":"scamper/http/client/ClientSettings.html","n":"keepAlive","t":"def keepAlive(enable: Boolean): ClientSettings","d":"scamper/http/client/ClientSettings","k":"def"},
...
{"l":"scamper/http/client/HttpClient.html","n":"keepAlive","t":"def keepAlive: Boolean","d":"scamper/http/client/HttpClient","k":"def"},
...
{"l":"scamper/http/cookies/CookieStore$$Null$.html","n":"clear","t":"def clear(expiredOnly: Boolean): Null.type","d":"scamper/http/cookies/CookieStore$$Null$","k":"def"},
...
{"l":"scamper/http/cookies/CookieStore$$Null$.html","n":"put","t":"def put(target: Uri, cookies: Seq[SetCookie]): Null.type","d":"scamper/http/cookies/CookieStore$$Null$","k":"def"},
...
{"l":"scamper/http/multipart.html","n":"tupleToByteArrayPart","t":"given tupleToByteArrayPart: tupleToByteArrayPart.type","d":"scamper/http/multipart","k":"given"},
{"l":"scamper/http/multipart.html","n":"tupleToFilePart","t":"given tupleToFilePart: tupleToFilePart.type","d":"scamper/http/multipart","k":"given"},
{"l":"scamper/http/multipart.html","n":"tupleToStringPart","t":"given tupleToStringPart: tupleToStringPart.type","d":"scamper/http/multipart","k":"given"},
{"l":"scamper/http/multipart/Multipart.html","n":"Multipart","t":"trait Multipart","d":"scamper/http/multipart/Multipart","k":"trait"},
{"l":"scamper/http/multipart/Multipart.html","n":"getBytes","t":"def getBytes(name: String): Option[Array[Byte]]","d":"scamper/http/multipart/Multipart","k":"def"},
...
{"l":"scamper/http/multipart/Multipart.html","n":"getString","t":"def getString(name: String): Option[String]","d":"scamper/http/multipart/Multipart","k":"def"},
...
{"l":"scamper/http/multipart/Part.html","n":"fileName","t":"def fileName: Option[String]","d":"scamper/http/multipart/Part","k":"def"},
{"l":"scamper/http/multipart/Part.html","n":"getBytes","t":"def getBytes(): Array[Byte]","d":"scamper/http/multipart/Part","k":"def"},
{"l":"scamper/http/multipart/Part.html","n":"getFile","t":"def getFile(): File","d":"scamper/http/multipart/Part","k":"def"},
{"l":"scamper/http/multipart/Part.html","n":"getString","t":"def getString(): String","d":"scamper/http/multipart/Part","k":"def"},
{"l":"scamper/http/multipart/Part.html","n":"name","t":"def name: String","d":"scamper/http/multipart/Part","k":"def"},
{"l":"scamper/http/multipart/Part.html","n":"size","t":"def size: Long","d":"scamper/http/multipart/Part","k":"def"},
{"l":"scamper/http/multipart/Part.html","n":"withInputStream","t":"def withInputStream[T](f: InputStream => T): T","d":"scamper/http/multipart/Part","k":"def"},
{"l":"scamper/http/multipart/Part$.html","n":"Part","t":"object Part","d":"scamper/http/multipart/Part$","k":"object"},
{"l":"scamper/http/multipart/Part$.html","n":"apply","t":"def apply(name: String, content: String): Part","d":"scamper/http/multipart/Part$","k":"def"},
{"l":"scamper/http/multipart/Part$.html","n":"apply","t":"def apply(name: String, content: Array[Byte]): Part","d":"scamper/http/multipart/Part$","k":"def"},
{"l":"scamper/http/multipart/Part$.html","n":"apply","t":"def apply(name: String, content: Array[Byte], offset: Int, length: Int): Part","d":"scamper/http/multipart/Part$","k":"def"},
{"l":"scamper/http/multipart/Part$.html","n":"apply","t":"def apply(name: String, content: File): Part","d":"scamper/http/multipart/Part$","k":"def"},
{"l":"scamper/http/multipart/Part$.html","n":"apply","t":"def apply(name: String, content: File, fileName: Option[String]): Part","d":"scamper/http/multipart/Part$","k":"def"},
{"l":"scamper/http/multipart/Part$.html","n":"apply","t":"def apply(contentDisposition: DispositionType, contentType: MediaType, content: String): Part","d":"scamper/http/multipart/Part$","k":"def"},
{"l":"scamper/http/multipart/Part$.html","n":"apply","t":"def apply(contentDisposition: DispositionType, contentType: MediaType, content: Array[Byte]): Part","d":"scamper/http/multipart/Part$","k":"def"},
{"l":"scamper/http/multipart/Part$.html","n":"apply","t":"def apply(contentDisposition: DispositionType, contentType: MediaType, content: File): Part","d":"scamper/http/multipart/Part$","k":"def"},
{"l":"scamper/http/multipart/tupleToByteArrayPart$.html","n":"tupleToByteArrayPart","t":"object tupleToByteArrayPart extends Conversion[(String, Array[Byte]), Part]","d":"scamper/http/multipart/tupleToByteArrayPart$","k":"object"},
{"l":"scamper/http/multipart/tupleToByteArrayPart$.html","n":"apply","t":"def apply(part: (String, Array[Byte])): Part","d":"scamper/http/multipart/tupleToByteArrayPart$","k":"def"},
{"l":"scamper/http/multipart/tupleToFilePart$.html","n":"tupleToFilePart","t":"object tupleToFilePart extends Conversion[(String, File), Part]","d":"scamper/http/multipart/tupleToFilePart$","k":"object"},
{"l":"scamper/http/multipart/tupleToFilePart$.html","n":"apply","t":"def apply(part: (String, File)): Part","d":"scamper/http/multipart/tupleToFilePart$","k":"def"},
{"l":"scamper/http/multipart/tupleToStringPart$.html","n":"tupleToStringPart","t":"object tupleToStringPart extends Conversion[(String, String), Part]","d":"scamper/http/multipart/tupleToStringPart$","k":"object"},
{"l":"scamper/http/multipart/tupleToStringPart$.html","n":"apply","t":"def apply(part: (String, String)): Part","d":"scamper/http/multipart/tupleToStringPart$","k":"def"},
...
{"l":"scamper/http/server/CriticalService.html","n":"CriticalService","t":"trait CriticalService","d":"scamper/http/server/CriticalService","k":"trait"},
...
{"l":"scamper/http/server/HttpServer.html","n":"HttpServer","t":"trait HttpServer extends AutoCloseable","d":"scamper/http/server/HttpServer","k":"trait"},
...
{"l":"scamper/http/server/LifecycleEvent.html","n":"LifecycleEvent","t":"enum LifecycleEvent(server: HttpServer) extends EventObject","d":"scamper/http/server/LifecycleEvent","k":"enum"},
{"l":"scamper/http/server/LifecycleEvent$$Start.html","n":"Start","t":"case Start(server: HttpServer) extends LifecycleEvent","d":"scamper/http/server/LifecycleEvent","k":"case"},
{"l":"scamper/http/server/LifecycleEvent$$Stop.html","n":"Stop","t":"case Stop(server: HttpServer) extends LifecycleEvent","d":"scamper/http/server/LifecycleEvent","k":"case"},
{"l":"scamper/http/server/LifecycleEvent$$Start.html","n":"Start","t":"case Start(server: HttpServer) extends LifecycleEvent","d":"scamper/http/server/LifecycleEvent$$Start","k":"case"},
{"l":"scamper/http/server/LifecycleEvent$$Stop.html","n":"Stop","t":"case Stop(server: HttpServer) extends LifecycleEvent","d":"scamper/http/server/LifecycleEvent$$Stop","k":"case"},
{"l":"scamper/http/server/LifecycleException.html","n":"LifecycleException","t":"class LifecycleException(message: String, cause: Throwable) extends RuntimeException","d":"scamper/http/server/LifecycleException","k":"class"},
{"l":"scamper/http/server/LifecycleException.html","n":"this","t":"def this()","d":"scamper/http/server/LifecycleException","k":"def"},
{"l":"scamper/http/server/LifecycleException.html","n":"this","t":"def this(message: String)","d":"scamper/http/server/LifecycleException","k":"def"},
{"l":"scamper/http/server/LifecycleException.html","n":"this","t":"def this(cause: Throwable)","d":"scamper/http/server/LifecycleException","k":"def"},
{"l":"scamper/http/server/LifecycleHook.html","n":"LifecycleHook","t":"trait LifecycleHook extends EventListener","d":"scamper/http/server/LifecycleHook","k":"trait"},
{"l":"scamper/http/server/LifecycleHook.html","n":"isCriticalService","t":"def isCriticalService: Boolean","d":"scamper/http/server/LifecycleHook","k":"def"},
{"l":"scamper/http/server/LifecycleHook.html","n":"process","t":"def process(event: LifecycleEvent): Unit","d":"scamper/http/server/LifecycleHook","k":"def"},
...
{"l":"scamper/http/server/Router.html","n":"trigger","t":"def trigger(hook: LifecycleHook): Router","d":"scamper/http/server/Router","k":"def"},
...
{"l":"scamper/http/server/ServerApplication.html","n":"trigger","t":"def trigger(hook: LifecycleHook): ServerApplication","d":"scamper/http/server/ServerApplication","k":"def"},
...
{"l":"scamper/http/types.html","n":"stringToByteContentRange","t":"given stringToByteContentRange: stringToByteContentRange.type","d":"scamper/http/types","k":"given"},
{"l":"scamper/http/types.html","n":"stringToByteRange","t":"given stringToByteRange: stringToByteRange.type","d":"scamper/http/types","k":"given"},
{"l":"scamper/http/types.html","n":"stringToCacheDirective","t":"given stringToCacheDirective: stringToCacheDirective.type","d":"scamper/http/types","k":"given"},
{"l":"scamper/http/types.html","n":"stringToCharsetRange","t":"given stringToCharsetRange: stringToCharsetRange.type","d":"scamper/http/types","k":"given"},
{"l":"scamper/http/types.html","n":"stringToContentCoding","t":"given stringToContentCoding: stringToContentCoding.type","d":"scamper/http/types","k":"given"},
{"l":"scamper/http/types.html","n":"stringToContentCodingRange","t":"given stringToContentCodingRange: stringToContentCodingRange.type","d":"scamper/http/types","k":"given"},
{"l":"scamper/http/types.html","n":"stringToDispositionType","t":"given stringToDispositionType: stringToDispositionType.type","d":"scamper/http/types","k":"given"},
{"l":"scamper/http/types.html","n":"stringToEntityTag","t":"given stringToEntityTag: stringToEntityTag.type","d":"scamper/http/types","k":"given"},
{"l":"scamper/http/types.html","n":"stringToKeepAliveParameters","t":"given stringToKeepAliveParameters: stringToKeepAliveParameters.type","d":"scamper/http/types","k":"given"},
{"l":"scamper/http/types.html","n":"stringToLanguageRange","t":"given stringToLanguageRange: stringToLanguageRange.type","d":"scamper/http/types","k":"given"},
{"l":"scamper/http/types.html","n":"stringToLanguageTag","t":"given stringToLanguageTag: stringToLanguageTag.type","d":"scamper/http/types","k":"given"},
{"l":"scamper/http/types.html","n":"stringToLinkType","t":"given stringToLinkType: stringToLinkType.type","d":"scamper/http/types","k":"given"},
{"l":"scamper/http/types.html","n":"stringToMediaRange","t":"given stringToMediaRange: stringToMediaRange.type","d":"scamper/http/types","k":"given"},
{"l":"scamper/http/types.html","n":"stringToMediaType","t":"given stringToMediaType: stringToMediaType.type","d":"scamper/http/types","k":"given"},
{"l":"scamper/http/types.html","n":"stringToPragmaDirective","t":"given stringToPragmaDirective: stringToPragmaDirective.type","d":"scamper/http/types","k":"given"},
{"l":"scamper/http/types.html","n":"stringToPreference","t":"given stringToPreference: stringToPreference.type","d":"scamper/http/types","k":"given"},
{"l":"scamper/http/types.html","n":"stringToProductType","t":"given stringToProductType: stringToProductType.type","d":"scamper/http/types","k":"given"},
{"l":"scamper/http/types.html","n":"stringToProtocol","t":"given stringToProtocol: stringToProtocol.type","d":"scamper/http/types","k":"given"},
{"l":"scamper/http/types.html","n":"stringToTransferCoding","t":"given stringToTransferCoding: stringToTransferCoding.type","d":"scamper/http/types","k":"given"},
{"l":"scamper/http/types.html","n":"stringToTransferCodingRange","t":"given stringToTransferCodingRange: stringToTransferCodingRange.type","d":"scamper/http/types","k":"given"},
{"l":"scamper/http/types.html","n":"stringToViaType","t":"given stringToViaType: stringToViaType.type","d":"scamper/http/types","k":"given"},
{"l":"scamper/http/types.html","n":"stringToWarningType","t":"given stringToWarningType: stringToWarningType.type","d":"scamper/http/types","k":"given"},
...
{"l":"scamper/http/types/stringToByteContentRange$.html","n":"stringToByteContentRange","t":"object stringToByteContentRange extends Conversion[String, ByteContentRange]","d":"scamper/http/types/stringToByteContentRange$","k":"object"},
...
{"l":"scamper/http/types/stringToByteRange$.html","n":"stringToByteRange","t":"object stringToByteRange extends Conversion[String, ByteRange]","d":"scamper/http/types/stringToByteRange$","k":"object"},
...
{"l":"scamper/http/types/stringToCacheDirective$.html","n":"stringToCacheDirective","t":"object stringToCacheDirective extends Conversion[String, CacheDirective]","d":"scamper/http/types/stringToCacheDirective$","k":"object"},
...
{"l":"scamper/http/types/stringToCharsetRange$.html","n":"stringToCharsetRange","t":"object stringToCharsetRange extends Conversion[String, CharsetRange]","d":"scamper/http/types/stringToCharsetRange$","k":"object"},
...
{"l":"scamper/http/types/stringToContentCoding$.html","n":"stringToContentCoding","t":"object stringToContentCoding extends Conversion[String, ContentCoding]","d":"scamper/http/types/stringToContentCoding$","k":"object"},
...
{"l":"scamper/http/types/stringToContentCodingRange$.html","n":"stringToContentCodingRange","t":"object stringToContentCodingRange extends Conversion[String, ContentCodingRange]","d":"scamper/http/types/stringToContentCodingRange$","k":"object"},
...
{"l":"scamper/http/types/stringToDispositionType$.html","n":"stringToDispositionType","t":"object stringToDispositionType extends Conversion[String, DispositionType]","d":"scamper/http/types/stringToDispositionType$","k":"object"},
...
{"l":"scamper/http/types/stringToEntityTag$.html","n":"stringToEntityTag","t":"object stringToEntityTag extends Conversion[String, EntityTag]","d":"scamper/http/types/stringToEntityTag$","k":"object"},
...
{"l":"scamper/http/types/stringToKeepAliveParameters$.html","n":"stringToKeepAliveParameters","t":"object stringToKeepAliveParameters extends Conversion[String, KeepAliveParameters]","d":"scamper/http/types/stringToKeepAliveParameters$","k":"object"},
...
{"l":"scamper/http/types/stringToLanguageRange$.html","n":"stringToLanguageRange","t":"object stringToLanguageRange extends Conversion[String, LanguageRange]","d":"scamper/http/types/stringToLanguageRange$","k":"object"},
...
{"l":"scamper/http/types/stringToLanguageTag$.html","n":"stringToLanguageTag","t":"object stringToLanguageTag extends Conversion[String, LanguageTag]","d":"scamper/http/types/stringToLanguageTag$","k":"object"},
...
{"l":"scamper/http/types/stringToLinkType$.html","n":"stringToLinkType","t":"object stringToLinkType extends Conversion[String, LinkType]","d":"scamper/http/types/stringToLinkType$","k":"object"},
...
{"l":"scamper/http/types/stringToMediaRange$.html","n":"stringToMediaRange","t":"object stringToMediaRange extends Conversion[String, MediaRange]","d":"scamper/http/types/stringToMediaRange$","k":"object"},
...
{"l":"scamper/http/types/stringToMediaType$.html","n":"stringToMediaType","t":"object stringToMediaType extends Conversion[String, MediaType]","d":"scamper/http/types/stringToMediaType$","k":"object"},
...
{"l":"scamper/http/types/stringToPragmaDirective$.html","n":"stringToPragmaDirective","t":"object stringToPragmaDirective extends Conversion[String, PragmaDirective]","d":"scamper/http/types/stringToPragmaDirective$","k":"object"},
...
{"l":"scamper/http/types/stringToPreference$.html","n":"stringToPreference","t":"object stringToPreference extends Conversion[String, Preference]","d":"scamper/http/types/stringToPreference$","k":"object"},
...
{"l":"scamper/http/types/stringToProductType$.html","n":"stringToProductType","t":"object stringToProductType extends Conversion[String, ProductType]","d":"scamper/http/types/stringToProductType$","k":"object"},
...
{"l":"scamper/http/types/stringToProtocol$.html","n":"stringToProtocol","t":"object stringToProtocol extends Conversion[String, Protocol]","d":"scamper/http/types/stringToProtocol$","k":"object"},
...
{"l":"scamper/http/types/stringToTransferCoding$.html","n":"stringToTransferCoding","t":"object stringToTransferCoding extends Conversion[String, TransferCoding]","d":"scamper/http/types/stringToTransferCoding$","k":"object"},
...
{"l":"scamper/http/types/stringToTransferCodingRange$.html","n":"stringToTransferCodingRange","t":"object stringToTransferCodingRange extends Conversion[String, TransferCodingRange]","d":"scamper/http/types/stringToTransferCodingRange$","k":"object"},
...
{"l":"scamper/http/types/stringToViaType$.html","n":"stringToViaType","t":"object stringToViaType extends Conversion[String, ViaType]","d":"scamper/http/types/stringToViaType$","k":"object"},
...
{"l":"scamper/http/types/stringToWarningType$.html","n":"stringToWarningType","t":"object stringToWarningType extends Conversion[String, WarningType]","d":"scamper/http/types/stringToWarningType$","k":"object"},
...
{"l":"scamper/http/websocket.html","n":"stringToWebSocketExtension","t":"given stringToWebSocketExtension: stringToWebSocketExtension.type","d":"scamper/http/websocket","k":"given"},
...
{"l":"scamper/http/websocket/WebSocketConnection.html","n":"WebSocketConnection","t":"class WebSocketConnection(socket: Socket) extends AutoCloseable","d":"scamper/http/websocket/WebSocketConnection","k":"class"},
...
{"l":"scamper/http/websocket/WebSocketSession$.html","n":"forClient","t":"def forClient(conn: WebSocketConnection, id: String, target: Uri, version: String, deflate: Boolean): WebSocketSession","d":"scamper/http/websocket/WebSocketSession$","k":"def"},
{"l":"scamper/http/websocket/WebSocketSession$.html","n":"forClient","t":"def forClient(socket: Socket, id: String, target: Uri, version: String, deflate: Boolean): WebSocketSession","d":"scamper/http/websocket/WebSocketSession$","k":"def"},
{"l":"scamper/http/websocket/WebSocketSession$.html","n":"forServer","t":"def forServer(conn: WebSocketConnection, id: String, target: Uri, version: String, deflate: Boolean): WebSocketSession","d":"scamper/http/websocket/WebSocketSession$","k":"def"},
{"l":"scamper/http/websocket/WebSocketSession$.html","n":"forServer","t":"def forServer(socket: Socket, id: String, target: Uri, version: String, deflate: Boolean): WebSocketSession","d":"scamper/http/websocket/WebSocketSession$","k":"def"},
{"l":"scamper/http/websocket/stringToWebSocketExtension$.html","n":"stringToWebSocketExtension","t":"object stringToWebSocketExtension extends Conversion[String, WebSocketExtension]","d":"scamper/http/websocket/stringToWebSocketExtension$","k":"object"},
