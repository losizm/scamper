...
implicit class SecWebSocketProtocol[T <: HttpMessage](message: T) extends AnyVal:
...
implicit class SecWebSocketProtocolServer(response: HttpResponse) extends AnyVal:
